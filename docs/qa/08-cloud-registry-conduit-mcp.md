...
- **Failure and recovery assertions:** Any all-zero account/zone/database ID, placeholder sender, or unowned namespace ID is an automatic release block.
- **Accessibility assertions:** Not applicable.
